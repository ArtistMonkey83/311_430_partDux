...
//processing each instruction in the commands file one getline() at a time
      switch(tolower(caseID))
      {
        case a:                     /*
                    ...
                    something.add(stringFromFile[it]);       //Add the elements [1]-[4] by dereferencing an iterator (pointer) of the stringFromFile variable.
                    break;
        ...
        case d:                   /*
                                  ...
                                  */
                    for(int it =1; it < stringFromFile.size(); it++)    //Starting at elemnt[1] till the last element in the string...
                    something.remove(it)       //Remove the elements [1]-[4] by dereferencing an iterator (pointer) of the stringFromFile variable.
                    break;
        ...
        case f:                   /*
                                  ...
                                  */
                    for(int it = 1; it < stringFromFile.size(); it++)    //Starting at elemnt[1] till the last element in the string...
                    something.contains(it)       //Add the elements [1]-[4] by dereferencing an iterator (pointer) of the stringFromFile variable.
                    break;
        ...
        case r:                   /*
                   ...
                   something.add(it)       //Add the elements [1]-[4] by dereferencing an iterator (pointer) of the stringFromFile variable.
                   break;
